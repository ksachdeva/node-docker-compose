...
declare namespace Dockerode {
  ...
  interface ContainerInspectInfo {
    ...
    Args: string[];
    State: {
      Status: string; Running: boolean; Paused: boolean; Restarting: boolean;
      OOMKilled: boolean;
      Dead: boolean;
      Pid: number;
      ExitCode: number;
    ...
    NetworkSettings: {
      ...
      SecondaryIPv6Addresses?: any; EndpointID: string; Gateway: string;
      GlobalIPv6Address: string;
      GlobalIPv6PrefixLen: number;
      IPAddress: string;
      IPPrefixLen: number;
      ...
      Networks: {
        [type: string]: {
          IPAMConfig?: any;
          Links?: any;
          Aliases?: any; NetworkID: string; EndpointID: string; Gateway: string;
          IPAddress: string;
          IPPrefixLen: number;
          IPv6Gateway: string;
          GlobalIPv6Address: string;
      ...
      Node?: {
        ID: string; IP: string; Addr: string; Name: string; Cpus: number;
        Memory: number;
        Labels: any;
      }
    };
  ...
  interface DockerVersion {
    ...
    Components: Array<{
      Details: {
        ApiVersion: string; Arch: string; BuilTime: Date; Experimental: string;
        GitCommit: string;
        GoVersion: string;
